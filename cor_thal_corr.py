...
cortex = np.genfromtxt(env.data + '/structural/striatumR_SA_NV_10to21_2closestTo16.csv', delimiter=',')
...
np.savez(env.results + 'structurals_pearson_all_thalamus_all_striatum_3orMore', corr=corr, pvals=pvals, my_sub_vertices=my_sub_vertices)
