...
path_sMRI = importdata('/Volumes/rbraid/mr_data/tonya/scripts_quality_assurance_at_9/Paths_T1_F9_withconsent_start_3124.txt') ;
t1_ratings = importdata('/Volumes/rbraid/mr_data/tonya/scripts_quality_assurance_at_9/IDC_ratings_Orlaugh_n500.txt') ;

% Set the output path for the image quality data
outpath_vals = '/Volumes/rbraid/mr_data/tonya/scripts_quality_assurance_at_9/IDC_Automated_ratings_F9_consent_n3124_to_end.csv' ;
...
path_1 = '/Volumes/rbraid/xnat/nii/GenR_F9_MRI/' ;
path_2 = '/t1.nii.gz ' ;
path_2a = ' ' ;
...
for i = 1 : n
    ...
    cmd_a = [cmd_1 imgpath path_2a path_4 path_2] ;
    [k1,k2] = system(cmd_a) ;
    ...
    ii = i + 3123 ;
    values(i,:) = [ii topbrain anterior posterior noisemean noisestd rarea larea r2area l2area reyearea leyearea fftmaxovermean rightymax righty5 rightygrad leftymax lefty5 leftygrad] ;
    system(cmd_c) 
