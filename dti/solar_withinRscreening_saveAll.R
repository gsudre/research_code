# runs linear mixed model for DTI traits and saves beta, tstat and pval for all covariates
library(nlme)
library(MASS)
...
out_fname = '~/data/solar_paper_review/all_covariates_dti_linear_interaction_interactionSquared.csv'
p_thresh = .05
...
terms = c('sx', 'sex', 'mvmt', 'I(mvmt^2)', 'age', 'sx:age', 'I(age^2)', 'sx:I(age^2)')
