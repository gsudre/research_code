...
g2 = 'persistent'
g3 = 'persistent'
load(sprintf('~/data/structural/all_data_gf_1473_dsm%d_matchedDiff_on18_1to1.RData', dsm))
gf = read.csv(sprintf('~/data/structural/gf_1473_dsm45_matched_on18_dsm%d_diff_1to1.csv', dsm))
