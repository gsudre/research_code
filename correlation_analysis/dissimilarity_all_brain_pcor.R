...
striatumL = read.csv('~/data/structural/roisSum_striatumL_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
thalamusL = read.csv('~/data/structural/roisSum_thalamusL_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
gpL = read.csv('~/data/structural/roisSum_gpL_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
cortexL = read.csv('~/data/structural/roisSum_cortexL_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
striatumR = read.csv('~/data/structural/roisSum_striatumR_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
thalamusR = read.csv('~/data/structural/roisSum_thalamusR_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
gpR = read.csv('~/data/structural/roisSum_gpR_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
cortexR = read.csv('~/data/structural/roisSum_cortexR_QCCIVETlt35_QCSUBePASS_MATCHSCRIPT_dsm5.csv')
