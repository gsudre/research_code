...
g2 = 'NV'
g3 = 'remission'
load('~/data/structural/cortical_volumes_gf_1473_dsm5_matchedDiff_on18_2to1_v2.RData')
load('~/data/structural/subcortical_volumes_gf_1473_dsm5_matchedDiff_on18_2to1_v2.RData')
...
subcortexVol = subcortexVol[idx_last | idx_base,]
cortexVol = cortexVol[idx_last | idx_base,]
