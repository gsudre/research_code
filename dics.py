"""Beamformer approach from the Hildebrand paper.
"""

# Authors: Gustavo Sudre, based on Alex's code
#
...
def lcmv_raw(raw, forward, noise_cov, data_cov, reg=0.01, label=None,
    ...
    stc = _apply_beamformer(data, info, tmin, forward, noise_cov, data_cov, reg,
                      label, picks)
