#!/usr/local/bin/tclsh
#10-29-03 0942 missing values not correctly accessed by lindex
#10-29-03 0928 ssrt is not rt but inhdly
#10-29-03 0905 sti.rt inhdly is index 3
#10-29-03 0859 not getting totrt for sti data inhdly then average
#10-29-03 0847 eliminate debug output for clarity
#05-03-02 1346 ssrtstp.tcl run twice with different file arguments
...
#   set tmp [lindex $line 3]
    #Caution if missing values are present, indices are not correct
...
# puts "InhDly Summation|$inhdly|dd|$dd|"
}
if {$dd!=0} {
