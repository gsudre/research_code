...
data_dir = home + '/data/fmri_example11_all/555/'
subjs_fname = home + '/data/fmri_example11_all/4min.txt'
...
mask = nb.load(data_dir + '/brain_mask_555.nii')
# good voxels
...
fname = res_dir + 'catFamAndSibs4minZeroFilled_R%02d.npz' % nreal
