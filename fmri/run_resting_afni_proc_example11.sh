...
#       -out_dir $subj_dir/$subj.rest.example11.results               \
#       -script $subj_dir/rest.proc.example11.$subj               \
...
# tcsh -xef $subj_dir/rest.proc.example11.$subj 2>&1 | tee $subj_dir/output.rest.example11.proc.$subj
