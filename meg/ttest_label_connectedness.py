...
g2_fname = '/Users/sudregp/data/meg/remitted_subjs.txt'
...
for b in range(len(bands)):
    ...
    best_connections = ['%s (%.2g)'%(labels[idx].name, val[idx]) for idx in np.argsort(val) if val[idx]<.05]
