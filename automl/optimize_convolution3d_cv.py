...
def create_model(activation):
    #encoder
    x = Conv3D(32, (3, 3, 3), activation=activation, padding='same')(input_img)
    x = MaxPooling3D(pool_size=(2, 2, 2))(x) 
    x = Conv3D(16, (3, 3, 3), activation=activation, padding='same')(x)
    x = MaxPooling3D(pool_size=(2, 2, 2))(x) 
    x = Conv3D(8, (3, 3, 3), activation=activation, padding='same')(x)
    x = MaxPooling3D(pool_size=(2, 2, 2))(x) 
    x = Conv3D(4, (3, 3, 3), activation=activation, padding='same')(x)
    encoded = MaxPooling3D(pool_size=(7, 7, 3))(x)

    #decoder
    x = Conv3D(4, (3, 3, 3), activation=activation, padding='same')(encoded)
    x = UpSampling3D((7,7,3))(x)
    x = Conv3D(8, (3, 3, 3), activation=activation, padding='same')(x)
    x = UpSampling3D((2,2,2))(x)
    x = Conv3D(16, (3, 3, 3), activation=activation, padding='same')(x) 
    x = UpSampling3D((2,2,2))(x)
    x = Conv3D(32, (3, 3, 3), activation=activation, padding='same')(x)
    x = UpSampling3D((2,2,2))(x)
    decoded = Conv3D(1, (3, 3, 3), activation=activation, padding='same')(x)
