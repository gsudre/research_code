...
def create_model(init_mode='glorot_uniform', activation='relu', optimizer='adadelta'):
    #encoder
...
params = ['SGD', 'RMSprop', 'Adagrad', 'Adadelta', 'Adam', 'Adamax', 'Nadam']
param_grid = dict(optimizer=params)
